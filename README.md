...
- I should have planed this more properly from the start, so that I could have had more time to implement more features and polish the game. That would also help me have a better structerd code
